...
SRC_URI="https://github.com/VSCodium/vscodium/releases/download/1.99.32562/VSCodium-linux-x64-1.99.32562.tar.gz.sha1 -> VSCodium-linux-x64-1.99.32562.tar.gz.sha1"
RESTRICT="strip"
LICENSE="MIT"
SLOT="0"
KEYWORDS="amd64"
